module NUCLEATION_IMPLANT
    ...
    subroutine InitSimu_IMPLANT()
        ...
        allocate(NBPV(m_BKind))

        NBPV = 0.D0

        NBPV(1) = m_ConCentrat0
    ...
    !***************************************************
    subroutine NucleationSimu_IMPLANT()
        implicit none
        !---Local Vars---
        integer::CKind
        integer::IKind
        ...
        logical::adjustlTime
        !---Body---
        allocate(tempNBPV(m_BKind))

        allocate(tempNBPVChangeRate(m_BKind))
    ...
    !---------------------------------------------
    subroutine Put_Out_IMPLANT(Step,TTime,TStep,ImplantedNum,NPOWER0Ave,NPOWER1DIV2Ave,NPOWER1Ave,NPOWER3DIV2Ave)
        implicit none
        !---Dummy Vars---
